...
def browse(request):
    ...
    investor_filter = InvestorFilter(request.GET, queryset=all_investor)
    return render(request, 'investor/browse.html', {'filter': investor_filter, 'all_investor': all_investor, 'all_status': all_status})
