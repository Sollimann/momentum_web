...
def browse(request):
    ...
    startup_filter = StartupFilter(request.GET, queryset=all_startups)
    return render(request, 'startups/browse.html', {'filter':startup_filter,'all_startups': all_startups, 'all_industry': all_industry,
                                                    'all_sectors': all_sectors, 'all_status': all_status})
